...
// ─── COMPARTILHAR ───
function shareApp() {
  const text = '🥣 Venha conhecer o Açaineiro - O melhor açaí de Contagem! Peça já pelo app: http://localhost:3000/app';
  if (navigator.share) {
    navigator.share({ title: 'Açaineiro', text, url: 'http://localhost:3000/app' }).catch(() => {});
